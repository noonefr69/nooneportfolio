      ...
      <div className="grid lg:grid-cols-6 gap-4">
        <div className="lg:col-span-4">
          ...
          <p className="lg:text-base text-sm mt-2 text-muted-foreground">
            I don’t have much to say about myself, but at least I know that I’m
            a self-learner. I try to contribute. I started programming ’cause
            why not.
          </p>
          <p className="lg:text-base text-sm mt-2 text-muted-foreground">
          ...
          <p className="lg:text-base text-sm mt-2 text-muted-foreground">
            I’m a CS student at Azad University, Tabriz. Maybe if I study a
            little bit more, I might get into a good university.
          </p>
          <p className="lg:text-base text-sm mt-2 text-muted-foreground">
            My mess-ups keep leveling up day by day. I’m looking for interesting
            projects to contribute to. If something happens to me, it’s my
            fault.
          </p>
          <p className="lg:text-base text-sm mt-2 text-muted-foreground">
        ...
        <div className="lg:col-span-2 relative">
          ...
          <p className="text-end text-muted-foreground text-xs lg:text-sm font-semibold duration-100 hover:opacity-100 opacity-70">
            Don{`'`}t wait for the moon, because I don{`'`}t go out of my
            room...
          </p>
        </div>
      </div>
